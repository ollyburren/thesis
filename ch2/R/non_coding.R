...
year <- 2001:2017
papers.miRNA <- sapply(year, search_year, term="miRNA", USE.NAMES=FALSE)
papers.lincRNA <- sapply(year, search_year, term="lincRNA", USE.NAMES=FALSE)
papers.noncoding <- sapply(year, search_year, term="noncoding", USE.NAMES=FALSE)
papers.enhancer <- sapply(year, search_year, term="enhancer", USE.NAMES=FALSE)
